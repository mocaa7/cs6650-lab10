 ...
 */
public class _unused_BullyAlgo implements Runnable {
    ...
    public _unused_BullyAlgo(String operation) {
        this.operation = operation;

    }

    public _unused_BullyAlgo(String operation, String reqtype) {
        this.operation = operation;
    ...
    public static void main(String args[]) throws UnknownHostException, IOException, InterruptedException {
        initialize();
        Runnable receiver = new _unused_BullyAlgo("receiver");
        new Thread(receiver).start();

        // Thread.sleep(10);

        Runnable heartbeat = new _unused_BullyAlgo("heartbeat");
        ...
        if (operation.equals("timer")) {
            ...
            try {
                ...
                if (!received) {
                    ...
                    Runnable sender = new _unused_BullyAlgo("sender", "cood");
                ...
                if (received && !leader_flag) {
                    ...
                    Runnable sender = new _unused_BullyAlgo("sender", "elecreq");
                    new Thread(sender).start();
                ...
                while (true) {
                    ...
                    if (option.equals("elecreq")) {
                        ...
                        if (self_id > source_id) {
                            Runnable sender = new _unused_BullyAlgo("sender", "ok");
                            new Thread(sender).start();
                        ...
                        if (!election_req) {
                            ...
                            Runnable timer = new _unused_BullyAlgo("timer");
